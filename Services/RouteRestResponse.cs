...
namespace MobileSrc.Commuter.Shared.RouteServices.Rest {
    ...
    [System.Xml.Serialization.XmlRootAttribute(ElementName = "Response", Namespace="http://schemas.microsoft.com/search/local/ws/rest/v1", IsNullable=true)]
    public partial class RouteRestResponse {
